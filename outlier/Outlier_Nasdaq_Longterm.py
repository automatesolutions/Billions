...
if nasdaq_tickers:
    ...
    if not performance_df.empty:
        ...
        outlier_dir = r"C:\Users\jonel\OneDrive\Desktop\Jonel_Projects\Market_Analysis\outlier\data"
        funda_dir = r"C:\Users\jonel\OneDrive\Desktop\Jonel_Projects\Market_Analysis\funda\data"
        os.makedirs(outlier_dir, exist_ok=True)
        os.makedirs(funda_dir, exist_ok=True)
        
        # Save to both directories
        performance_df.to_csv(os.path.join(outlier_dir, "nasdaq_longterm_performance_metrics.csv"))
        performance_df.to_csv(os.path.join(funda_dir, "nasdaq_longterm_performance_metrics.csv"))
        outliers.to_csv(os.path.join(outlier_dir, "nasdaq_longterm_outliers.csv"))
        
        print(f"Results saved to:\n- {os.path.join(outlier_dir, 'nasdaq_longterm_performance_metrics.csv')}\n- {os.path.join(funda_dir, 'nasdaq_longterm_performance_metrics.csv')}\n- {os.path.join(outlier_dir, 'nasdaq_longterm_outliers.csv')}")
    else:
