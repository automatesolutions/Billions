...
if nasdaq_tickers:
    ...
    performance_df.to_csv(os.path.join(outlier_dir, "nasdaq_swing_performance_metrics.csv"))
    performance_df.to_csv(os.path.join(funda_dir, "nasdaq_swing_performance_metrics.csv"))
    outliers.to_csv(os.path.join(outlier_dir, "nasdaq_swing_outliers.csv"))
    
    print(f"Results saved to:\n- {os.path.join(outlier_dir, 'nasdaq_swing_performance_metrics.csv')}\n- {os.path.join(funda_dir, 'nasdaq_swing_performance_metrics.csv')}\n- {os.path.join(outlier_dir, 'nasdaq_swing_outliers.csv')}")
else:
